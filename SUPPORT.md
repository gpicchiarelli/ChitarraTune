...
**La mia interfaccia audio non viene usata.** Sul Mac scegli l'interfaccia dal menu del microfono nella barra degli strumenti della finestra; l'accordatore ascolta il canale d'ingresso su cui si trova davvero la chitarra. Su iPhone e iPad collegala prima di avviare l'ascolto: l'ingresso lo sceglie iOS.
...
**Che versione ho?** È scritta nella finestra Informazioni e in cima al resoconto diagnostico.
